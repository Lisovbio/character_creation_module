...
def attack(char_name: str, char_class: str) -> str:
    """
    Задаём параметры 'атаки' для каждого класса персонажей.
    В качестве параметров выступают имя и класс персонажа.
    """
...
def defence(char_name: str, char_class: str) -> str:
    """
    Задаём параметры 'защиты' для каждого класса персонажей.
    В качестве параметров выступают имя и класс персонажа.
    """
    if char_class == 'warrior':
    ...
    return (f'{char_name} не провёл защиту')


def special(char_name: str, char_class: str) -> str:
    """
    Задаём параметры 'специальных умений' для каждого класса персонажей.
    В качестве параметров выступают имя и класс персонажа.
    """
    if char_class == 'warrior':
        return (
...
def start_training(char_name: str, char_class: str) -> str:
    """
    Запуск цикла тренировки навыков персонажа.
    В качестве параметров выступают имя и класс персонажа.
    """
    if char_class == 'warrior':
